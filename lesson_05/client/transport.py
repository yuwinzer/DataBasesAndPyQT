...
class ClientTransport(threading.Thread, QObject):
    ...
    def __init__(self, database, acc_name, serv_ip, serv_port):  # database, acc_name, serv_ip, serv_port
        ...
        try:
            ...
            for knock in range(5):
                ...
                try:
                    ...
                    # LOGGER.debug(f'Соединение установлено. Отправляю сообщение о присутствии...')
